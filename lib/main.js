...
function onInsecurePasswordDecision(decision)
{
    ...
    {
        warningPanel.show();
        menuPanel.contentURL = data.url("menuPanelPageWarning.html");
    }
    else if(decision.type == resultEnum.FORM)
    {
        warningPanel.show();
        menuPanel.contentURL = data.url("menuPanelFormWarning.html");
    }
    else
    {
        menuPanel.contentURL = data.url("menuPanel.html");
    }
}
