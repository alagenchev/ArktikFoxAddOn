...
const Panel = Symbiont.resolve({
  ...
  show: function show(anchor) {
    ...
    if (!xulPanel) {
      ...
      // border-radius makes a rounded border
      let css =
          ".panel-inner-arrowcontent, .panel-arrowcontent {padding: 0; border-radius: 15px;}";
    ...
    if (!anchor) {
      ...
      y = document.documentElement.clientHeight - 1.5 * height;
      position = null;
    }
    else {
